...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 745206483646522275, ; hash 0xa5781593e11a3a3, from name: MagicBrickFrontend
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 3182670887053425824, ; hash 0x2c2b1e4f2bcbfca0, from name: aot-MagicBrickFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MagicBrickFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 84
	...
	%struct.DSOCacheEntry {
		i64 5363846143980897538, ; hash 0x4a7035a629d48502, from name: aot-MagicBrickFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MagicBrickFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 136
	...
	%struct.DSOCacheEntry {
		i64 10127988863473276042, ; hash 0x8c8dd836006fd48a, from name: libaot-MagicBrickFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MagicBrickFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 279
	...
	%struct.DSOCacheEntry {
		i64 10217079057698235777, ; hash 0x8dca5b45442fa581, from name: libaot-MagicBrickFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MagicBrickFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 281
	...
	%struct.DSOCacheEntry {
		i64 14127067155328861775, ; hash 0xc40d6cbab777064f, from name: MagicBrickFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MagicBrickFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 398
